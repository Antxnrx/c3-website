        ...
        <div className="bg-white rounded-xl p-8 md:p-12 text-black border border-slate-300" style={{ borderWidth: '0.5px' }}>
          ...
          <div className="space-y-10 text-sm font-light text-black/70 leading-relaxed">
            ...
            <section>
              ...
              <p>
                If you have any questions about these Terms of Use, please contact us at <a href="mailto:hello@cloudcommunity.com" className="text-blue-600 hover:text-blue-700 transition-colors underline">hello@cloudcommunity.com</a>
              </p>
            </section>
