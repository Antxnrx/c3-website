  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center justify-start px-8 md:px-16 lg:px-24 pt-40 md:pt-48">
      ...
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16 lg:gap-24">
        ...
        {/* Divider */}
        <div className="hidden md:block w-px h-32 bg-[#000000a3]/30"></div>
        
        {/* Description */}
        <div className="flex-1 max-w-md">
          <p className="text-sm font-light text-[#000000a3] leading-relaxed tracking-wide text-center md:text-left">
        ...
        <div className="flex flex-row gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center">
            <NumberTicker value={700} suffix="+" className="text-2xl md:text-3xl font-light text-[#000000a3] tracking-tight" />
            <span className="text-[10px] font-light text-[#000000a3]/70 tracking-widest uppercase mt-1">members</span>
          </div>
          
          <div className="flex flex-col items-center">
            <NumberTicker value={8} suffix="+" className="text-2xl md:text-3xl font-light text-[#000000a3] tracking-tight" />
            <span className="text-[10px] font-light text-[#000000a3]/70 tracking-widest uppercase mt-1">contributors</span>
          </div>
          
          <div className="flex flex-col items-center">
            <span className="text-2xl md:text-3xl font-light text-[#000000a3] tracking-tight">Global</span>
